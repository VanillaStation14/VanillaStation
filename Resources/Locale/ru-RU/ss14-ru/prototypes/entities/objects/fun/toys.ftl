...
ent-plushiejoseph = плюшевый капитан
    .desc = Плюшевая игрушка ввиде человека в парадной форме офицера НТ, пахнет плазмой и маковым чаем. На бирке у головы написано "Произведено в Нью-Сайберии".
