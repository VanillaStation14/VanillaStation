...
public class MapLoadBenchmark
{
    ...
    public static readonly string[] MapsSource = { "Cluster", "Empty", "Satlern", "Box", "Bagel", "Dev", "CentComm", "Core", "TestTeg", "Packed", "Omega", "Reach", "Meta", "Marathon", "MeteorArena", "Fland", "Oasis", "Cog" };
